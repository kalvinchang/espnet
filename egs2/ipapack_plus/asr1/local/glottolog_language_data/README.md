...
Contains only the `cldf/languages.csv`, metadata and licensing files from the original version that can be found here: https://doi.org/10.5281/zenodo.14006636
